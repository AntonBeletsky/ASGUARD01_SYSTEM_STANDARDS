...
|---|---|---|---|
| `llm-operational-platform-task-execution-methodology-full-in-one-file-md.md` | **A** | ~985 | Methodology + implementation, merged into one document |
| `llm-operational-platform-task-execution-methodology.md` | **B** | ~335 | Methodology alone, implementation-agnostic |
| `llm-assembler.md` | **B** | ~390 | The tool's operating instructions, readable copy |
